...
int main(void)
{
  ...
  TFT_string(0,6,White,Black,"  OK-STM767 ???? ????? MP3 ?¡À????  ");
  ...
  TFT_string(0, 0, White,Magenta, "  OK-STM767 ???? ????? MP3 ?¡À????  ");
  TFT_string(0, 3, Cyan,   Black, "----------------------------------------");
  TFT_string(0, 5, Magenta,Black, ">>");
  TFT_string(0, 7, Cyan,   Black, "----------------------------------------");
  TFT_string(0, 9, Cyan,   Black, "      ???? ??? : 000/000 (   kbps)     ");
  TFT_string(0,11, Cyan,   Black, "      ???? ?•X : 0000KB  (     Hz)     ");
  ...
  while(1)
	...
	{ case KEY1: play_flag ^= 0x01;		// toggle play or stop
                     if(play_flag == 1) TFT_string(33,13, Yellow, Black, "??????");
                     else               TFT_string(33,13, Magenta,Black, " ???? ");
                     break;
